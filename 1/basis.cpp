 ...
 * 					生成对象时会根据具体的参数列表来区分调用有参构造函数还是无参构造函数
 * 	id = id1;
 * 	name = name1;
 * 	if(math1 < 0){
 ...
 * }
 */
		stu()		//构造函数与类名相同 - 调用时不需要提供参数的构造函数为 默认构造函数
		{			//不提供构造函数时使用系统默认构造函数， 提供默认构造函数后系统默认构造函数自动失效
			id = 0;	//有参构造函数中若参数有默认值，调用时不需要提供参数 也可以称为默认构造函数
			name="";
			math = 0;
